          ...
          {auth.isAuthenticated ? (
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-3">
                <span className="text-2xl font-bold text-primary">{auth.userName?.charAt(0) || "U"}</span>
              </div>
              <p className="font-semibold text-lg mb-1">{auth.userName || "사용자"} 님</p>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-semibold text-lg mb-3">로그인 후 더 많은 서비스를 이용해보세요</h3>
