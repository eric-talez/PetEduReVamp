                  ...
                  <>
                    ...
                    {menuGroups.management && (
                      <>
                        ...
                        <AccessibleNavItem href="/my-points" icon={<Star className="w-5 h-5 mr-2" />} hoverIcon={<CreditCard className="w-5 h-5 mr-2 text-primary" />} active={isActive("/my-points")} onClick={handleItemClick} show={showTrainerMenu || showInstituteMenu}>내 포인트</AccessibleNavItem>
                        <AccessibleNavItem href="/rest-management" icon={<Calendar className="w-5 h-5 mr-2" />} hoverIcon={<Clock className="w-5 h-5 mr-2 text-primary" />} active={isActive("/rest-management")} onClick={handleItemClick} show={showTrainerMenu || showInstituteMenu}>휴식 관리</AccessibleNavItem>
                        <AccessibleNavItem href="/substitute-management" icon={<UserCheck className="w-5 h-5 mr-2" />} hoverIcon={<RefreshCw className="w-5 h-5 mr-2 text-primary" />} active={isActive("/substitute-management")} onClick={handleItemClick} show={showTrainerMenu || showInstituteMenu}>대체 훈련사</AccessibleNavItem>
                        <AccessibleNavItem href="/notebook-management" icon={<FileText className="w-5 h-5 mr-2" />} hoverIcon={<Edit className="w-5 h-5 mr-2 text-primary" />} active={isActive("/notebook-management")} onClick={handleItemClick} show={showTrainerMenu || showInstituteMenu}>알림장 관리</AccessibleNavItem>
