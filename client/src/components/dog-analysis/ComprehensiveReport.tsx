              ...
              <Tabs defaultValue="motion" className="w-full">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex justify-between items-center py-2 border-b">
                        ...
                        <span className="text-gray-700">{report.behaviorAnalysisSummary?.stressLevel || '-'}</span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b">
                ...
                <TabsContent value="survey" className="space-y-4">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-gray-600">설문 데이터를 기반으로 한 분석 결과가 여기에 표시됩니다.</p>
                    </CardContent>
                  </Card>
                </TabsContent>
                ...
                <TabsContent value="correlation" className="space-y-4">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-gray-600">모션, 행동, 설문 데이터 간의 상관관계 분석 결과입니다.</p>
                    </CardContent>
                  </Card>
                </TabsContent>
                ...
                <TabsContent value="recommendations" className="space-y-4">
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      {(report.aiRecommendations || []).map((rec: string, idx: number) => (
                  ...
                  {report.healthAlerts && report.healthAlerts.length > 0 && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="flex items-center">
                  ...
                  {report.trainingAdvice && report.trainingAdvice.length > 0 && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="flex items-center">
