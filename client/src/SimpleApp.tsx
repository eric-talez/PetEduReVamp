                ...
                <Switch>
                  ...
                  <Route path="/trainer/referrals">
                    {() => {
                      ...
                      return (
                        <Suspense fallback={<div className="p-8 text-center">추천 코드 관리 로딩 중...</div>}>
                          <TrainerReferrals />
                        </Suspense>
                      );
                    }}
  ...
  return (
    <AppLayout>
      <Switch>
        ...
        <Route path="/admin/menu-management" component={() => {
        ...
        <Route path="/admin/institutes" component={() => {
        ...
        <Route path="/admin/trainers" component={() => {
