...
## Recent Changes
- **2025-10-26**: Unified location services routing - "근처 훈련소 찾기" (Find Nearby Training Centers) menu now displays institutes page with comprehensive location filters (region, breed, certification). /location-finder route now renders institutes/index.tsx for consistent user experience.
