...
function createTestExcel() {
  ...
  const data = [
    ...
    [''],
    ['== 강의 구성 =='],
    ['회차', '강의명', '설명', '시간(분)', '무료여부', '개별가격', '준비물'],
    ['1', '재활 기초 평가', '반려동물의 신체 상태 평가 및 재활 계획 수립', '90', 'Y', '0', '체크리스트, 평가지, 줄자'],
    ['2', '기초 운동치료', '기본적인 물리치료 및 운동요법', '60', 'N', '100000', '운동 매트, 간식, 장난감'],
    ['3', '전문 재활 운동', '맞춤형 재활 운동 프로그램', '120', 'N', '150000', '재활 도구, 밸런스 볼, 슬링'],
    ['4', '재활 효과 평가', '재활 진행 상황 평가 및 조정', '90', 'N', '100000', '재평가 도구, 측정 기구'],
    ['5', '가정 관리 교육', '집에서 할 수 있는 관리 방법', '60', 'N', '50000', '홈케어 가이드, 운동 도구']
  ];
